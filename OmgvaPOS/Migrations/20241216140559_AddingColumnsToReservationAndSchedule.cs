...
{
    /// <inheritdoc />
    public partial class AddingColumnsToReservationAndSchedule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StripeReaders", x => x.ReaderId);
                    table.ForeignKey(
                        name: "FK_StripeReaders_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemVariationGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<long>(type: "bigint", nullable: false),
                    GiftcardPaymentEntityId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_GiftcardPayments_GiftcardPaymentEntityId",
                        column: x => x.GiftcardPaymentEntityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemVariations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItemVariations_ItemVariations_ItemVariationId",
                        column: x => x.ItemVariationId,
                        principalTable: "ItemVariations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItemVariations_OrderItems_OrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemVariations_ItemVariationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_GiftcardPaymentEntityId",
                table: "Payments",
                column: "GiftcardPaymentEntityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StripeReaders_BusinessId",
                table: "StripeReaders",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxItems_ItemId",
                table: "TaxItems",
                column: "ItemId");
